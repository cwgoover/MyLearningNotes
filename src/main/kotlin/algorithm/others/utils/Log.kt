package algorithm.others.utils
...
object Log {
    ...
    fun d(msg: String, color: String) {
        println(color + msg + ConsoleColors.RESET)
    }
    
    fun d(msg: String) {
        println(ConsoleColors.CYAN_BRIGHT + msg + ConsoleColors.RESET)
    }
    
    fun i(msg: String) {
        println(ConsoleColors.GREEN_BRIGHT + msg + ConsoleColors.RESET)
    }
    
    fun w(msg: String) {
        println(ConsoleColors.YELLOW_BRIGHT + msg + ConsoleColors.RESET)
    }
    
    fun e(msg: String) {
        println(ConsoleColors.RED_BRIGHT + msg + ConsoleColors.RESET)
    }
}
